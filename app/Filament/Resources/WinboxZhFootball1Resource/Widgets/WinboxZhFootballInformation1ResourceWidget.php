...
namespace App\Filament\Resources\WinboxZhFootball1Resource\Widgets;
...
class WinboxZhFootballInformation1ResourceWidget extends BaseWidget
{
    // 设置表格标题
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                ...
                WinboxZhFootballInformation1::query()
            )
            ->columns([
