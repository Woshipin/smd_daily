...
class WinboxThbJackpotInformationEnWidget extends BaseWidget
{
    protected static ?string $heading = 'Winbox thb Jackpot Information (English)';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxThbJackpotInformationEn::query()
            )
            ->columns([
