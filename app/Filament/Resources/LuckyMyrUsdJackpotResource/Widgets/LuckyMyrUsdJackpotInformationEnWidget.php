...
namespace App\Filament\Resources\LuckyMyrUsdJackpotResource\Widgets;
...
class LuckyMyrUsdJackpotInformationEnWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                LuckyMyrUsdJackpotInformationEn::query()
            )
            ->columns([
