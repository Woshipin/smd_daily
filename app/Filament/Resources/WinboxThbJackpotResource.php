...
use App\Filament\Resources\WinboxThbJackpotResource\Pages;
use App\Filament\Resources\WinboxThbJackpotResource\RelationManagers;
...
class WinboxThbJackpotResource extends Resource
{
    protected static ?string $model = WinboxThbJackpot::class;
    ...
    protected static ?string $navigationLabel = 'Winbox Jackpot 管理 (thb)';
    protected static ?string $modelLabel = 'Winbox Jackpot 管理  (thb)';
    protected static ?string $pluralModelLabel = 'Winbox Jackpot 管理 (thb)';
    ...
    {
        return [
            'index' => Pages\ListWinboxThbJackpots::route('/'),
            'create' => Pages\CreateWinboxThbJackpot::route('/create'),
            'edit' => Pages\EditWinboxThbJackpot::route('/{record}/edit'),
        ];
    }
}
