...
use App\Filament\Resources\WinboxMyrUsdJackpotResource\Pages;
use App\Filament\Resources\WinboxMyrUsdJackpotResource\RelationManagers;
...
class WinboxMyrUsdJackpotResource extends Resource
{
    protected static ?string $model = WinboxMyrUsdJackpot::class;
    ...
    protected static ?string $navigationLabel = 'Winbox Jackpot 管理 (myr-usd)';
    protected static ?string $modelLabel = 'Winbox Jackpot 管理  (myr-usd)';
    protected static ?string $pluralModelLabel = 'Winbox Jackpot 管理 (myr-usd)';
    ...
    {
        return [
            'index' => Pages\ListWinboxMyrUsdJackpots::route('/'),
            'create' => Pages\CreateWinboxMyrUsdJackpot::route('/create'),
            'edit' => Pages\EditWinboxMyrUsdJackpot::route('/{record}/edit'),
        ];
    }
}
