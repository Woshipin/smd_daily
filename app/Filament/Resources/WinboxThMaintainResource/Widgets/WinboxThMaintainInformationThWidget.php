...
namespace App\Filament\Resources\WinboxThMaintainResource\Widgets;
...
class WinboxThMaintainInformationThWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxThMaintainInformationTh::query()
            )
            ->heading('维护详情')
            ->columns([
                ...
                Tables\Columns\TextColumn::make('start_date')
                    ->label('开始时间')
                    ->description(fn (WinboxThMaintainInformationTh $record): string => $record->start_time ?? '-'),

                Tables\Columns\TextColumn::make('completion_date')
                    ->label('完成时间')
                    ->description(fn (WinboxThMaintainInformationTh $record): string => $record->completion_time ?? '-'),
