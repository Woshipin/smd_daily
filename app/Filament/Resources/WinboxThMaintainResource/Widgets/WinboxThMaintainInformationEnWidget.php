...
class WinboxThMaintainInformationEnWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxThMaintainInformationEn::query()
            )
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('start_date')
                    ->label('Start')
                    ->description(fn (WinboxThMaintainInformationEn $record): string => $record->start_time ?? '-'),

                Tables\Columns\TextColumn::make('completion_date')
                    ->label('Completion')
                    ->description(fn (WinboxThMaintainInformationEn $record): string => $record->completion_time ?? '-'),
