...
use App\Filament\Resources\WinboxThMaintainResource\Pages;
use App\Filament\Resources\WinboxThMaintainResource\RelationManagers;
...
class WinboxThMaintainResource extends Resource
{
    protected static ?string $model = WinboxThMaintain::class;
    ...
    protected static ?string $navigationLabel = 'Winbox Maintain 管理 (th)';
    protected static ?string $modelLabel = 'Winbox Maintain 管理  (th)';
    protected static ?string $pluralModelLabel = 'Winbox Maintain 管理 (th)';
    ...
    {
        return [
            'index' => Pages\ListWinboxThMaintains::route('/'),
            'create' => Pages\CreateWinboxThMaintain::route('/create'),
            'edit' => Pages\EditWinboxThMaintain::route('/{record}/edit'),
        ];
    }
}
