...
use App\Filament\Resources\WinboxZhFootball2Resource\Pages;
use App\Filament\Resources\WinboxZhFootball2Resource\RelationManagers;
...
class WinboxZhFootball2Resource extends Resource
{
    protected static ?string $model = WinboxZhFootball2::class;
    ...
    {
        return [
            'index' => Pages\ListWinboxZhFootball2s::route('/'),
            'create' => Pages\CreateWinboxZhFootball2::route('/create'),
            'edit' => Pages\EditWinboxZhFootball2::route('/{record}/edit'),
        ];
    }
}
