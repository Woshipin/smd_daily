...
use App\Filament\Resources\LuckyMyrUsdJackpotResource\Pages;
use App\Filament\Resources\LuckyMyrUsdJackpotResource\RelationManagers;
...
class LuckyMyrUsdJackpotResource extends Resource
{
    protected static ?string $model = LuckyMyrUsdJackpot::class;
    ...
    protected static ?string $navigationLabel = 'Lucky Jackpot 管理 (myr-usd)';
    protected static ?string $modelLabel = 'Lucky Jackpot 管理  (myr-usd)';
    protected static ?string $pluralModelLabel = 'Lucky Jackpot 管理 (myr-usd)';
            ...
            ->schema([
                ...
                Section::make('第二层 (详细标签与数值)')
                    ->schema([
                        ...
                        // 标签组
                        FormGrid::make(2)->schema([
                            TextInput::make('detail_label_thai_1')->label('Detail Label (Zh 1)'),
                            TextInput::make('detail_label_english_1')->label('Detail Label (English 1)'),
                            TextInput::make('detail_label_thai_2')->label('Detail Label (Zh 2)'),
    ...
    {
        return [
            'index' => Pages\ListLuckyMyrUsdJackpots::route('/'),
            'create' => Pages\CreateLuckyMyrUsdJackpot::route('/create'),
            'edit' => Pages\EditLuckyMyrUsdJackpot::route('/{record}/edit'),
        ];
    }
}
