...
namespace App\Filament\Resources\WinboxZhFootball2Resource\Widgets;
...
class WinboxZhFootballInformation2ResourceWidget extends BaseWidget
{
    // 设置表格标题
    protected int | string | array $columnSpan = 'full'; // 让表格占满全宽
    protected static ?string $heading = '足球赛事资讯列表 - 2 (my) - Information';

    public function table(Table $table): Table
    {
        return $table
            ->query(
                // 这里指定使用 WinboxZhFootballInformation1 模型
                WinboxZhFootballInformation2::query()
            )
            ->columns([
