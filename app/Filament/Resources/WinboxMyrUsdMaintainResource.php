...
use App\Filament\Resources\WinboxMyrUsdMaintainResource\Pages;
use App\Filament\Resources\WinboxMyrUsdMaintainResource\RelationManagers;
...
class WinboxMyrUsdMaintainResource extends Resource
{
    protected static ?string $model = WinboxMyrUsdMaintain::class;
    ...
    protected static ?string $navigationLabel = 'Winbox Maintain 管理 (myr-usd)';
    protected static ?string $modelLabel = 'Winbox Maintain 管理  (myr-usd)';
    protected static ?string $pluralModelLabel = 'Winbox Maintain 管理 (myr-usd)';
    ...
    {
        return [
            'index' => Pages\ListWinboxMyrUsdMaintains::route('/'),
            'create' => Pages\CreateWinboxMyrUsdMaintain::route('/create'),
            'edit' => Pages\EditWinboxMyrUsdMaintain::route('/{record}/edit'),
        ];
    }
}
