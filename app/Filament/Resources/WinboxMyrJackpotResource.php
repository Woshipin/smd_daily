...
use App\Filament\Resources\WinboxMyrJackpotResource\Pages;
...
class WinboxMyrJackpotResource extends Resource
{
    protected static ?string $model = WinboxMyrJackpot::class;
    ...
    protected static ?string $navigationLabel = 'Winbox Jackpot 管理 (myr)';
    protected static ?string $modelLabel = 'Winbox Jackpot 管理  (myr)';
    protected static ?string $pluralModelLabel = 'Winbox Jackpot 管理 (myr)';
    ...
    {
        return [
            'index' => Pages\ListWinboxMyrJackpots::route('/'),
            'create' => Pages\CreateWinboxMyrJackpot::route('/create'),
            'edit' => Pages\EditWinboxMyrJackpot::route('/{record}/edit'),
        ];
    }
}