...
use App\Filament\Resources\WinboxThbUsdJackpotResource\Pages;
use App\Filament\Resources\WinboxThbUsdJackpotResource\RelationManagers;
...
class WinboxThbUsdJackpotResource extends Resource
{
    protected static ?string $model = WinboxThbUsdJackpot::class;

    protected static ?string $navigationIcon = 'heroicon-o-currency-dollar';

    protected static ?string $navigationGroup = 'Winbox Jackpot (myr 和 thb) - (myr-usd 和 thb-usd)';
    protected static ?int $navigationSort = 0;

    protected static ?string $navigationLabel = 'Winbox Jackpot 管理 (thb-usd)';
    protected static ?string $modelLabel = 'Winbox Jackpot 管理  (thb-usd)';
    protected static ?string $pluralModelLabel = 'Winbox Jackpot 管理 (thb-usd)';
            ...
            ->schema([
                ...
                Section::make('第二层 (详细标签与数值)')
                    ->schema([
                        ...
                        // 标签组
                        FormGrid::make(2)->schema([
                            TextInput::make('detail_label_thai_1')->label('Detail Label (Thai 1)'),
                            TextInput::make('detail_label_english_1')->label('Detail Label (English 1)'),
                            TextInput::make('detail_label_thai_2')->label('Detail Label (Thai 2)'),
    ...
    {
        return [
            'index' => Pages\ListWinboxThbUsdJackpots::route('/'),
            'create' => Pages\CreateWinboxThbUsdJackpot::route('/create'),
            'edit' => Pages\EditWinboxThbUsdJackpot::route('/{record}/edit'),
        ];
    }
}
