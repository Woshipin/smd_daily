...
use App\Filament\Resources\LuckyMyrJackpotResource\Pages;
use App\Filament\Resources\LuckyMyrJackpotResource\RelationManagers;
...
class LuckyMyrJackpotResource extends Resource
{
    protected static ?string $model = LuckyMyrJackpot::class;
    ...
    protected static ?string $navigationLabel = 'Lucky Jackpot 管理 (myr)';
    protected static ?string $modelLabel = 'Lucky Jackpot 管理  (myr)';
    protected static ?string $pluralModelLabel = 'Lucky Jackpot 管理 (myr)';
    ...
    {
        return [
            'index' => Pages\ListLuckyMyrJackpots::route('/'),
            'create' => Pages\CreateLuckyMyrJackpot::route('/create'),
            'edit' => Pages\EditLuckyMyrJackpot::route('/{record}/edit'),
        ];
    }
}
