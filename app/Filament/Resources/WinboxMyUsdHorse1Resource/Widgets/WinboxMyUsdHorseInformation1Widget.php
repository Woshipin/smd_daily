...
namespace App\Filament\Resources\WinboxMyUsdHorse1Resource\Widgets;
...
class WinboxMyUsdHorseInformation1Widget extends BaseWidget
{
        // 设置表格标题
    protected int | string | array $columnSpan = 'full'; // 让表格占满全宽
    protected static ?string $heading = '赛马资讯列表 - 1 (my-usd) - Information';

    public function table(Table $table): Table
    {
        return $table
            ->query(
                // 这里指定使用 WinboxMyUsdHorseInformation1 模型
                WinboxMyUsdHorseInformation1::query()
            )
            ->columns([
            ...
            ->headerActions([
                ...
                Tables\Actions\CreateAction::make()
                    ->label('New 赛马资讯 - 1 (my-usd)') // 按钮显示的文字
                    ->form([
