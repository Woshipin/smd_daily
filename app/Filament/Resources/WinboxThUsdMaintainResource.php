...
use App\Filament\Resources\WinboxThUsdMaintainResource\Pages;
use App\Filament\Resources\WinboxThUsdMaintainResource\RelationManagers;
...
class WinboxThUsdMaintainResource extends Resource
{
    protected static ?string $model = WinboxThUsdMaintain::class;
...
protected static ?string $navigationIcon = 'heroicon-o-calendar-days';
    ...
    protected static ?string $navigationLabel = 'Winbox Maintain 管理 (th-usd)';
    protected static ?string $modelLabel = 'Winbox Maintain 管理  (th-usd)';
    protected static ?string $pluralModelLabel = 'Winbox Maintain 管理 (th-usd)';
    ...
    {
        return [
            'index' => Pages\ListWinboxThUsdMaintains::route('/'),
            'create' => Pages\CreateWinboxThUsdMaintain::route('/create'),
            'edit' => Pages\EditWinboxThUsdMaintain::route('/{record}/edit'),
        ];
    }
}
