...
class WinboxMyrMaintainInformationEnWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxMyrMaintainInformationEn::query()
            )
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('start_date')
                    ->label('Start')
                    ->description(fn (WinboxMyrMaintainInformationEn $record): string => $record->start_time ?? '-'),

                Tables\Columns\TextColumn::make('completion_date')
                    ->label('Completion')
                    ->description(fn (WinboxMyrMaintainInformationEn $record): string => $record->completion_time ?? '-'),
