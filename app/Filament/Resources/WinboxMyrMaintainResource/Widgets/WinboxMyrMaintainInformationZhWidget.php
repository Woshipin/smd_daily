...
namespace App\Filament\Resources\WinboxMyrMaintainResource\Widgets;
...
class WinboxMyrMaintainInformationZhWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxMyrMaintainInformationZh::query()
            )
            ->heading('维护详情')
            ->columns([
                ...
                Tables\Columns\TextColumn::make('start_date')
                    ->label('开始时间')
                    ->description(fn (WinboxMyrMaintainInformationZh $record): string => $record->start_time ?? '-'),

                Tables\Columns\TextColumn::make('completion_date')
                    ->label('完成时间')
                    ->description(fn (WinboxMyrMaintainInformationZh $record): string => $record->completion_time ?? '-'),
