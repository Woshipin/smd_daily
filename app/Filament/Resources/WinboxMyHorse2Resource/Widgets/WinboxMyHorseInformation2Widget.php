...
namespace App\Filament\Resources\WinboxMyHorse2Resource\Widgets;
...
class WinboxMyHorseInformation2Widget extends BaseWidget
{
    // 设置表格标题
    protected int | string | array $columnSpan = 'full'; // 让表格占满全宽
    protected static ?string $heading = '赛马资讯列表 - 2 (my) - Information';

    public function table(Table $table): Table
    {
        return $table
            ->query(
                // 这里指定使用 WinboxMyHorseInformation2 模型
                WinboxMyHorseInformation2::query()
            )
            ->columns([
