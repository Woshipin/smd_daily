...
namespace App\Filament\Resources\AtasMyFootball2Resource\Widgets;
...
class AtasMyFootballInformation2ResourceWidget extends BaseWidget
{
    // 设置表格标题
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                // 这里指定使用 AtasMyFootballInformation2 模型
                AtasMyFootballInformation2::query()
            )
            ->columns([
