...
class WinboxThUsdMaintainInformationEnWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxThUsdMaintainInformationEn::query()
            )
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('start_date')
                    ->label('Start')
                    ->description(fn (WinboxThUsdMaintainInformationEn $record): string => $record->start_time ?? '-'),

                Tables\Columns\TextColumn::make('completion_date')
                    ->label('Completion')
                    ->description(fn (WinboxThUsdMaintainInformationEn $record): string => $record->completion_time ?? '-'),
