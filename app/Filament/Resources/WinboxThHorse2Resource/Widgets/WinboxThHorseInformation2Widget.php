...
namespace App\Filament\Resources\WinboxThHorse2Resource\Widgets;
...
class WinboxThHorseInformation2Widget extends BaseWidget
{
        // 设置表格标题
    protected int | string | array $columnSpan = 'full'; // 让表格占满全宽
    protected static ?string $heading = '赛马资讯列表 - 2 (th) - Information';

    public function table(Table $table): Table
    {
        return $table
            ->query(
                // 这里指定使用 WinboxThHorseInformation2 模型
                WinboxThHorseInformation2::query()
            )
            ->columns([
