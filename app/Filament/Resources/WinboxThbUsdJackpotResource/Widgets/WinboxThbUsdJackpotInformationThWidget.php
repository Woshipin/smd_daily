...
class WinboxThbUsdJackpotInformationThWidget extends BaseWidget
{
    // 设置 Widget 标题
    protected static ?string $heading = 'Winbox thb-usd Jackpot Information (泰文)';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxThbUsdJackpotInformationTh::query()
            )
            ->columns([
