...
namespace App\Filament\Resources\WinboxThbUsdJackpotResource\Widgets;
...
class WinboxThbUsdJackpotInformationEnWidget extends BaseWidget
{
    protected static ?string $heading = 'Winbox thb-usd Jackpot Information (English)';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxThbUsdJackpotInformationEn::query()
            )
            ->columns([
