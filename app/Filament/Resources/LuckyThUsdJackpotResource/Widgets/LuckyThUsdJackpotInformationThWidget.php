...
namespace App\Filament\Resources\LuckyThUsdJackpotResource\Widgets;
...
class LuckyThUsdJackpotInformationThWidget extends BaseWidget
{
    // 设置 Widget 标题
    protected static ?string $heading = 'Lucky Jackpot Information (泰文)';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                LuckyThUsdJackpotInformationTh::query()
            )
            ->columns([
