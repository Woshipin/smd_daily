...
namespace App\Filament\Resources\WinboxMyrUsdJackpotResource\Widgets;
...
class WinboxMyrUsdJackpotInformationEnWidget extends BaseWidget
{
        protected static ?string $heading = 'Winbox myr-usd Jackpot Information (English)';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxMyrUsdJackpotInformationEn::query()
            )
            ->columns([
