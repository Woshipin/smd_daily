...
class WinboxMyrUsdJackpotInformationZhWidget extends BaseWidget
{
    // 设置 Widget 标题
    protected static ?string $heading = 'Winbox myr-usd Jackpot Information (中文)';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                WinboxMyrUsdJackpotInformationZh::query()
            )
            ->columns([
