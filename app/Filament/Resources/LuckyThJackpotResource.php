...
use App\Filament\Resources\LuckyThJackpotResource\Pages;
use App\Filament\Resources\LuckyThJackpotResource\RelationManagers;
...
class LuckyThJackpotResource extends Resource
{
    protected static ?string $model = LuckyThJackpot::class;
...
protected static ?string $navigationIcon = 'heroicon-o-currency-dollar';
    ...
    protected static ?string $navigationLabel = 'Lucky Jackpot 管理 (th)';
    protected static ?string $modelLabel = 'Lucky Jackpot 管理  (th)';
    protected static ?string $pluralModelLabel = 'Lucky Jackpot 管理 (th)';
    ...
    {
        return [
            'index' => Pages\ListLuckyThJackpots::route('/'),
            'create' => Pages\CreateLuckyThJackpot::route('/create'),
            'edit' => Pages\EditLuckyThJackpot::route('/{record}/edit'),
        ];
    }
}
