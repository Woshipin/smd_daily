    ...
    <style>
        ...
        */
        ...
        @media (min-width: 769px) {
            ...
            .detail-value { font-size: 21px; width: 250px; min-width: 250px; padding: 15px 35px; border-radius: 30px; }
            ...
            <div class="prize-cards">
                ...
                <div class="prize-card orange">
                    <div class="prize-card-top">
                        <div class="prize-amount-label">THB</div>
