    ...
    @foreach($jackpots as $jackpot)
        ...
        <div class="mobile-container">
            ...
            <section class="section-1">
                ...
                <div class="main-jackpot">THB{{ $jackpot->amount }}</div>

                <div class="pools-row">
                    <div class="pool-card red">
                        <div>
                            <div class="pool-title-cn">จำนวนแจ็คพอต</div>
                            <div class="pool-title-en">Jackpot pool amount</div>
                        </div>
                        <div class="price-pill red">THB{{ $jackpot->prize_value_today }}</div>
                    </div>
                    <div class="pool-card blue">
                        <div>
                            <div class="pool-title-cn">โบนัสที่แจกวันนี้</div>
                            <div class="pool-title-en">Bonus prize payout today</div>
                        </div>
                        <div class="price-pill blue">THB{{ $jackpot->prize_value_current }}</div>
                    </div>
                </div>
            </section>
            ...
            <section class="section-2">
                <div class="section-background">
                    ...
                    <div class="prize-card">
                        ...
                        <div class="card-row">
                            <div class="label-group">
                                <span class="label-cn">หน่วยที่ชนะ</span>
                        ...
                        <div class="card-row">
                            <div class="label-group">
                                <span class="label-cn">โบนัสที่ได้รับต่อหน่วย</span>
                                <span class="label-en">Bonus won per unit</span>
                            </div>
                            <div class="value-pill small-text">THB {{ $jackpot->detail_value_3 }}</div>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <section class="section-3">
            <div class="section-3-inner">
                ...
                @foreach($jackpotInformationZh as $info)
                    <div class="info-row">
                        <div class="info-label">{{ $info->summary_label_th }}</div>
                        <div class="info-value">{{ $info->summary_value_th }}</div>
                    </div>
                @endforeach
