    ...
    @foreach($jackpots as $jackpot)
        ...
        <div class="mobile-container">
            ...
            <section class="section-1">
                ...
                <div class="main-jackpot">RM{{ $jackpot->amount }}</div>
                ...
                <div class="pools-row">
                    <div class="pool-card red">
                        ...
                        <div class="price-pill red">RM{{ $jackpot->prize_value_today }}</div>
                    </div>
                    <div class="pool-card blue">
                        ...
                        <div class="price-pill blue">RM{{ $jackpot->prize_value_current }}</div>
                    </div>
                </div>
            </section>
                ...
                <div class="section-background">
                    ...
                    <div class="prize-card">
                        ...
                        <div class="card-row">
                            ...
                            <div class="value-pill small-text">RM {{ $jackpot->detail_value_3 }}</div>
                        </div>
                    </div>
                </div>
            </section>
