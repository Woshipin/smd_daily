    ...
    <div class="container">
        ...
        <div class="hero-section">
            <div class="hero-content">
                ...
                <img src="{{ asset('images/winbox_horse/horse-my-usd.jpg') }}" alt="Horse Racing" class="horse-image">
            </div>
        </div>

        @if($myusdhorse1->isNotEmpty())
            <!-- Schedule Section -->
            <div class="schedule-section">
                @foreach($myusdhorse1 as $myusdhorse1item)
                    <div class="schedule-item">
                        <div class="country-name">{!! $myusdhorse1item->location !!}</div>
                        <div class="time">{{ \Carbon\Carbon::parse($myusdhorse1item->time)->format('H:i') }} (GMT+8)</div>
                    </div>
        ...
        @if($myusdhorse1descriptions->isNotEmpty())
            @foreach($myusdhorse1descriptions as $myusdhorse1description)
                <!-- Details Section -->
                <div class="details-section">
                    <div class="section-title">{!! $myusdhorse1description->title !!}</div>
                    <div class="race-details">
                        <div class="race-info">{!! $myusdhorse1description->information !!}</div>
                    </div>
                </div>
            @endforeach
        @endif
