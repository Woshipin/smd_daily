    ...
    <div class="container">
        ...
        <div class="hero-section">
            <div class="hero-content">
                ...
                <img src="{{ asset('images/winbox_horse/horse-th-usd.jpg') }}" alt="Horse Racing" class="horse-image">
            </div>
        </div>

        @if($thusdhorse2->isNotEmpty())
            <!-- Schedule Section -->
            <div class="schedule-section">
                @foreach($thusdhorse2 as $thusdhorse2item)
                    <div class="schedule-item">
                        <div class="country-name">{!! $thusdhorse2item->location !!}</div>
                        <div class="time">{{ \Carbon\Carbon::parse($thusdhorse2item->time)->format('H:i') }} (GMT+7)</div>
                    </div>
        ...
        @if($thusdhorse2descriptions->isNotEmpty())
            @foreach($thusdhorse2descriptions as $thusdhorse2description)
                <!-- Details Section -->
                <div class="details-section">
                    <div class="section-title">{!! $thusdhorse2description->title !!}</div>
                    <div class="race-details">
                        <div class="race-info">{!! $thusdhorse2description->information !!}</div>
                    </div>
                </div>
            @endforeach
        @endif
