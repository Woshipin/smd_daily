...
<body>
    <div class="container">
        ...
        @if($thhorse1->isNotEmpty())
            <!-- Schedule Section -->
            <div class="schedule-section">
                @foreach($thhorse1 as $thhorse1item)
                    <div class="schedule-item">
                        <div class="country-name">{!! $thhorse1item->location !!}</div>
                        <div class="time">{{ \Carbon\Carbon::parse($thhorse1item->time)->format('H:i') }} (GMT+7)</div>
                    </div>
        ...
        @if($thhorse1descriptions->isNotEmpty())
            @foreach($thhorse1descriptions as $thhorse1description)
                <!-- Details Section -->
                <div class="details-section">
                    <div class="section-title">{!! $thhorse1description->title !!}</div>
                    <div class="race-details">
                        <div class="race-info">{!! $thhorse1description->information !!}</div>
                    </div>
                </div>
            @endforeach
        @endif
