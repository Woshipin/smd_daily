...
<body>
    <div class="container">
        ...
        @if($myusdhorse2->isNotEmpty())
            <!-- Schedule Section -->
            <div class="schedule-section">
                @foreach($myusdhorse2 as $myusdhorse2item)
                    <div class="schedule-item">
                        <div class="country-name">{!! $myusdhorse2item->location !!}</div>
                        <div class="time">{{ \Carbon\Carbon::parse($myusdhorse2item->time)->format('H:i') }} (GMT+8)</div>
                    </div>
        ...
        @if($myusdhorse2descriptions->isNotEmpty())
            @foreach($myusdhorse2descriptions as $myusdhorse2description)
                <!-- Details Section -->
                <div class="details-section">
                    <div class="section-title">{!! $myusdhorse2description->title !!}</div>
                    <div class="race-details">
                        <div class="race-info">{!! $myusdhorse2description->information !!}</div>
                    </div>
                </div>
            @endforeach
        @endif
