...
<body>
    <div class="container">
        ...
        @if($myhorse2->isNotEmpty())
            <!-- Schedule Section -->
            <div class="schedule-section">
                @foreach($myhorse2 as $myhorse2item)
                    <div class="schedule-item">
                        <div class="country-name">{!! $myhorse2item->location !!}</div>
                        <div class="time">{{ \Carbon\Carbon::parse($myhorse2item->time)->format('H:i') }} (GMT+8)</div>
                    </div>
        ...
        @if($myhorse2descriptions->isNotEmpty())
            @foreach($myhorse2descriptions as $myhorse2description)
                <!-- Details Section -->
                <div class="details-section">
                    <div class="section-title">{!! $myhorse2description->title !!}</div>
                    <div class="race-details">
                        <div class="race-info">{!! $myhorse2description->information !!}</div>
                    </div>
                </div>
            @endforeach
        @endif
