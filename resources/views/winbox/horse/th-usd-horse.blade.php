    ...
    <div class="container">
        ...
        <div class="hero-section">
            <div class="hero-content">
                ...
                <img src="{{ asset('images/winbox_horse/th-usd-horse-0.png') }}" alt="Horse Racing" class="horse-image">
            </div>
        </div>

        <!-- Details Section -- UPDATED -->
        <div class="details-section">
            <div class="section-title">การแข่งม้า 📢</div>
            <div class="race-info">
                🏇🔥 <br><strong>การพนันแข่งม้าขึ้นอยู่กับ</strong><br>
                หัว= USD 1,000<br>
                มุม= USD 1,000
            </div>
