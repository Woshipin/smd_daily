...
<body>
    <div class="container">
        ...
        @if($thusdhorse1->isNotEmpty())
            <!-- Schedule Section -->
            <div class="schedule-section">
                @foreach($thusdhorse1 as $thusdhorse1item)
                    <div class="schedule-item">
                        <div class="country-name">{!! $thusdhorse1item->location !!}</div>
                        <div class="time">{{ \Carbon\Carbon::parse($thusdhorse1item->time)->format('H:i') }} (GMT+7)</div>
                    </div>
        ...
        @if($thusdhorse1descriptions->isNotEmpty())
            @foreach($thusdhorse1descriptions as $thusdhorse1description)
                <!-- Details Section -->
                <div class="details-section">
                    <div class="section-title">{!! $thusdhorse1description->title !!}</div>
                    <div class="race-details">
                        <div class="race-info">{!! $thusdhorse1description->information !!}</div>
                    </div>
                </div>
            @endforeach
        @endif
