    ...
    <div class="container">
        ...
        <div class="hero-section">
            <div class="hero-content">
                ...
                <img src="{{ asset('images/winbox_horse/horse-my.jpg') }}" alt="Horse Racing" class="horse-image">
            </div>
        </div>

        @if($myhorse1->isNotEmpty())
            <!-- Schedule Section -->
            <div class="schedule-section">
                @foreach($myhorse1 as $myhorse1item)
                    <div class="schedule-item">
                        <div class="country-name">{!! $myhorse1item->location !!}</div>
                        <div class="time">{{ \Carbon\Carbon::parse($myhorse1item->time)->format('H:i') }} (GMT+8)</div>
                    </div>
        ...
        @if($myhorse1descriptions->isNotEmpty())
            @foreach($myhorse1descriptions as $myhorse1description)
                <!-- Details Section -->
                <div class="details-section">
                    <div class="section-title">{!! $myhorse1description->title !!}</div>
                    <div class="race-details">
                        <div class="race-info">{!! $myhorse1description->information !!}</div>
                    </div>
                </div>
            @endforeach
        @endif
